  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4 sm:p-8">
      ...
      <div className="w-full max-w-md rounded-lg border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="mb-6 text-center text-xl font-medium text-gray-800">Create Account</h2>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <input
              ...
              className={`h-10 w-full rounded-md border ${errors.name ? 'border-red-500' : 'border-gray-300'} px-3 py-2 text-black focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none`}
              required
            />
